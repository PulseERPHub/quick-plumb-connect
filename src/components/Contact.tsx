  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://script.google.com/macros/s/AKfycbyWDeCPUFEeIWnpMpwOH7yJO7pYVlD6gQcXJoM6wOfU7elzHjXMouMkondmjka4HDCE8w/exec",
        {
          method: "POST",
    ...
    <div id="contact" className="py-16 bg-blue-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-plumbing-darkgray">
            Contact Us
          </h2>
          <div className="h-1 w-20 bg-plumbing-blue mx-auto mt-4 mb-6"></div>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Get in touch with our team for any plumbing services or inquiries.
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2">
            <div className="bg-white rounded-lg shadow-lg p-8 h-full">
              <h3 className="text-xl font-semibold mb-6 text-plumbing-darkgray">
                Get In Touch
              </h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      callsouthcoastplumbing@gmail.com
                    </p>
                  </div>
                </div>
